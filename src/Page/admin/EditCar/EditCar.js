...
function EditCar() {
    ...
    useEffect(() => {
        axios
            ...
            .then((res) => {
                ...
                setAutomatic(res.data.automatic);
                setPetrol(res.data.petrol);
                setFrontWheelDrive(res.data.frontWheelDrive);
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await axios
            .put(`/admin/EditCar/${id}`, { name, year, price, automatic, petrol, frontWheelDrive, image })
            .then((response) => {
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('container')}>
                <div className={cx('header')}>Sửa thông tin ô tô</div>
                    ...
                    <div className={cx('contentRight')}>
                        <form>
                            ...
                            <div className={cx('right')}>
                                <div className={cx('text')}>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFrontWheelDrive(e.target.value)}
                                        className={cx('input')}
                                    />
                                </div>
                                <div className={cx('text')}>
                            ...
                            <div className={cx('btnCar')}>
                                <Link to={config.routers.ListCar} className={cx('btnhuy')}>
                                    Hủy
                                </Link>
                                <button onClick={handleSubmit} className={cx('btnAdd')}>
                                    Lưu
                                </button>
                            </div>
                        </form>
